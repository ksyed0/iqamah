...
- ENH-004 (macOS Notification Center widget) → ✅ Implemented — `IqamahWidget` target ships systemSmall/Medium/Large widgets (`IqamahWidget.swift`, `macOSLargeWidgetView.swift`)
